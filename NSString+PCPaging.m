...
- (NSString *)paginationWithAttributes:(NSDictionary *)attributes constrainedToSize:(CGSize)size withPageIndex:(NSInteger)pageIndex  {
    ...
    NSInteger rangeIndex = 0;
        ...
        //TODO      需要根据具体字号对最小值就行分别设定
        unsigned long length = MIN(size.width*2, attributedString.length - rangeIndex);
